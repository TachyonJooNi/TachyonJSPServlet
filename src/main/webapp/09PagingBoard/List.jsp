...
//전체페이지수를 계산한다. (전체게시물의갯수 / 페이지당게시물갯수 = 결과의 올림처리)
...
<body>
    ...
    <form method="get">  
    <table border="1" width="90%" class="table table-striped table-bordered">
    <tr>
        <td align="center">
...
<%
//List켈렉션에 저장된 내용이 없을때 true를 반환하는 isEmpty()메서드를 사용해서
//출력할 게시물이 있는지 확인한다.
    ...
    <table border="1" width="90%" class="table table-striped table-bordered">
        <tr align="center">
        	...
        	<!-- <button type='button' class='btn btn-secondary'
        	 onclick='document.location=`http://localhost:8088/K08JSPServlet/09PagingBoard/List.jsp?pageNum=2`'>[이전 블록]</button> -->
        		<!-- 
        	...
        	<!-- 글쓰기 버튼 -->
            <td><button class='btn btn-secondary' type="button" onclick="location.href='Write.jsp';" >글쓰기
                </button></td>
        </tr>
    </table>
</body>
