...
request영역
	...
	공유된다.
*/
request.setAttribute("requestString", "request 영역의 문자열");//문자열 데이터 저장
request.setAttribute("requestPerson", new Person("안중근", 31));//일반적인 객체 저장
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	포워드 : 현재 페이지로 들어온 요청을 다음 페이지로 보내는 기능을 말한다.
		즉 하나의 요청을 둘 이상의 페이지가 공유  할 수 있다.
