...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
선언부(Declarations) : 스크립트릿이나 표현식에서 사용할 메서드를 선언할때
...
<%
	...
	int sum = MyClass.myFunc(1, 100); // MyClass 자동완성하면 위에 자동으로 import된다.
	out.println("1~100까지의합:"+ sum); // 웹에 출력
	System.out.println("1~100까지의합:" + sum); // 콘솔에 출력
%>
</body>
</html>